...
public class FinalOrderPOJO implements Serializable{
    @SerializedName("id")
    @Expose
    private String id;
    ...
    @Expose
    private BidInfoPOJO bidProductInfo;
    ...
    public BidInfoPOJO getBidProductInfo() {
        return bidProductInfo;
    }

    public void setBidProductInfo(BidInfoPOJO bidProductInfo) {
